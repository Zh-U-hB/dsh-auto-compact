...
export function resolveConfig(raw) {
  ...
  return Object.freeze({
    thresholdTokens: parseTokenCount(raw.thresholdTokens, DEFAULT_THRESHOLD_TOKENS, 'thresholdTokens'),
    retainTokens: parseTokenCount(raw.retainTokens, DEFAULT_RETAIN_TOKENS, 'retainTokens'),
